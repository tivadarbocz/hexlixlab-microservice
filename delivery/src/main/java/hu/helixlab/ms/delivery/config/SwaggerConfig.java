package hu.helixlab.ms.delivery.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                ...
                // Scanning Path Pack
                .apis(RequestHandlerSelectors.basePackage("hu.helixlab.ms.delivery"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Routing Gateway(Zuul): swagger 2 Delivery module service")
